...
(function (h) {
    ...
    function Ca(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "Accune donnée dans la table" === b.sEmptyTable && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    var n = function (a) {
            ...
            this.each(function () {
                var e = {},
                    ...
                    l = n.defaults,
                    q = h(this);
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Pas de node de table à initiliser (" + this.nodeName + ")", 2);
                else {
                    fb(l);
                    gb(l.column);
                    J(l, l, !0);
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Montrant_entrés_de_MENU",
            sLoadingRecords: "Chargement...",
            sProcessing: "En Cours...",
            sSearch: "Rechercher:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Auccune correspondance trouvé",
        },
