...
(function (h) {
  ...
  function Ca(a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable &&
        d &&
        "Accune donnée dans la table" === b.sEmptyTable &&
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          K(
            null,
            0,
            "Pas de node de table à initiliser (" + this.nodeName + ")",
            2
          );
        else {
          fb(l);
          ...
          for (i = t.length; j < i; j++) {
            ...
            if (
              ...
              if (g.bDestroy !== k ? g.bDestroy : l.bDestroy) {
                ...
                K(o, 0, "La DataTable ne peut pas être initialiser", 3);
                return;
              }
            }
  ...
  n.defaults = {
    ...
    oLanguage: {
      oAria: {
        sSortAscending: ": Activer pour filtrer la colonne de façon croissante",
        sSortDescending: ": Activer pour filtrer la colonne de façon décroissante",
      },
      oPaginate: {
        sFirst: "Prémier",
        sLast: "Dernier",
      ...
      sInfo: "_START_ à _END_ entrées sur _TOTAL_ entrées total",
      ...
      sSearch: "Rechercher: ",
      sSearchPlaceholder: "Rechercher une donnée",
      sUrl: "",
      sZeroRecords: "Auccune correspondance trouvée",
    },
